...
```  
Then run `npm install` to install all packages, and `node server.js` to run the server.  
You can make calls to the `hello` function at `http://localhost:8081/hello`. It should return whatever your Google Cloud Function returns.
